    ...
    <div class="container">
        <div class="row justify-content-lg-center justify-content-md-center">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="sign_form">
                    <h2>Your account has been authorized successfully.</h2>
                    <p>Now you can start to learn everything now.</p>
                    ...
                    <a href="{{route('home')}}"><button class="login-btn"  type="submit">Home</button></a>
                </div>
