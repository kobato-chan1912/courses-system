    ...
    <div class="container">
        <div class="row justify-content-lg-center justify-content-md-center">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="sign_form">
                    <h2>Your password reset URL has been sent to your email.</h2>
                    <p>Login to your email and go to the url to reset password.</p>
                    ...
                    <a href="{{route('forgot')}}"><button class="login-btn"  type="submit">Resend</button></a>
                </div>
